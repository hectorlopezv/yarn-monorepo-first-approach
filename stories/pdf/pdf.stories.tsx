...
import {PdfFile_SC} from '@libprov/pdf'

export default {
  title: 'components/PdfFile_SC',
  component: PdfFile_SC,
  argTypes: {},
} as ComponentMeta<typeof PdfFile_SC>

const Template: ComponentStory<typeof PdfFile_SC> = args => {
