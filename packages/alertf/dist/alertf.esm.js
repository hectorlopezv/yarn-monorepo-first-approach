...
class t extends e.Component {
  ...
  render() {
    return e.createElement(
      ...
      e.createElement('i', {className: `fa ${this.icon}`}),
      e.createElement('div', {className: 'alert__message'}, this.props.mensaje),
      e.createElement(
        'a',
        {
        ...
        e.createElement('i', {className: 'fa fa-times-circle'}),
      ),
    )
  }
}
t.defaultProps = {type: 'alert-info', className: ''}
export {t as Alertf}
